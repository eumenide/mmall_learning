...
public class OrderServiceImpl implements IOrderService {
    ...
    private ServerResponse getCartOrderItem(Integer userId, List<Cart> cartList) {
        ...
        if (CollectionUtils.isEmpty(cartList)) {
            return ServerResponse.createByErrorMessage("购物车中勾选产品为空");
        }
    ...
    public ServerResponse pay(Integer userId, Long orderNo, String path) {
        ...
        for (OrderItem orderItem :
            ...
            GoodsDetail goodsDetail = GoodsDetail.newInstance(orderItem.getProductId().toString(),
                    orderItem.getProductName(), BigDecimalUtil.mul(orderItem.getCurrentUnitPrice().doubleValue(), 100d).longValue(),
    ...
    public ServerResponse aliCallback(Map<String, String> params) {
        ...
        // eumes 校验相关数据
        if (!order.getPayment().equals(new BigDecimal(params.get("total_amount")))) {
            return ServerResponse.createByErrorMessage("校验失败，回调忽略");
        }
